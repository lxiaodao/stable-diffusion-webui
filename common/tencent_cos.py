...
if __name__ == '__main__':
    ...
    '''访问文件列表'''
    bucket = OssDef()
    key_of_file="test04-123456789-image-white-shirt.jpg"
    #with open('D:/py-workspace/mysite/common/util/white-shirt.jpg', 'rb') as fp:
    #     returns=bucket.upload(fp, key_of_file)
    #     print(1,returns)
